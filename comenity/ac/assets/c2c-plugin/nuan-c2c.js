...
**/
   ...
   var BootStrapC2C = function(options) {
      ...
      this.closeBtn = typeof options.closeBtnOnActive == "undefined" ? false : options.closeBtnOnActive;
      ...
      this.c2cClickHandler = this.onC2CClicked.bind(this);
      this.c2cKeyPressHandler = this.onC2CKeyPressed.bind(this);
   ...
   **/
   ...
   BootStrapC2C.prototype.renderC2CButton = function (c2cData, isDisplay) {
         ...
         if (c2cData.launchable || c2cData.displayState == "chatactive" && this.closeBtn) {            
            el.addEventListener("click", this.c2cClickHandler);
            window.addEventListener("keydown", this.c2cKeyPressHandler);
         }
   ...
   **/
   ...
   BootStrapC2C.prototype.newMinimizedMessage = function(count,msgObject) {
      if(this.showMinimizedBadge) {
          if(!this.countEl) {
            let badgeEl = this.eDiv.querySelector(".badge");
   ...
   BootStrapC2C.prototype.onClose = function() {
      NuanMessaging.CIAPI.closeChat(); 
   };

   BootStrapC2C.prototype.clearListeners = function() {
      this.eDiv.removeEventListener("click", this.c2cClickHandler);
      window.removeEventListener("keydown", this.c2cKeyPressHandler);
   };
